            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div id="tableButtons" style="display:inline-block"></div>
                        ...
                        <div class="btn-group viewDropDown">
                            ...
                            <button class="btn btn-default dropdown-toggle" data-toggle="dropdown"><?= $this->__("links.group_by") ?></button>
                            <ul class="dropdown-menu">
                ...
                <div class="col-md-3">
                    <div class="pull-right">
                        ...
                        <div class="btn-group viewDropDown">
                            <button class="btn btn-default dropdown-toggle" data-toggle="dropdown"><?= $this->__("links.table-title") ?> <?= $this->__("links.view") ?></button>
                            <ul class="dropdown-menu">
                ...
                <div class="row" style="padding-left: 20px;">
                    ...
                    <div class="filterBoxLeft">
                        ...
                        <div class="form-group">
                            <select data-placeholder="<?= $this->__("input.placeholders.filter_by_user") ?>" title="<?= $this->__("input.placeholders.filter_by_user") ?>" name="users" multiple="multiple" style="height: auto!important;" class="user-select" id="userSelect">
                                <option value=""></option>
                    ...
                    <div class="filterBoxLeft">
                        <input type="text" style="height: 30px!important;" class="form-control input-default" id="termInput" name="term" placeholder="<?= $this->__("label.search_term") ?>" value="<?php $this->e($searchCriteria['term']); ?>">
                        <input type="submit" style="color:#fff;" value="<?= $this->__("buttons.search") ?>" name="search" class="form-control btn btn-primary" />
                    </div>
            ...
            <tbody>
                <?php foreach ($this->get('allTickets') as $row) { ?>
                    <tr>
                        ...
                        ?>
                        <td data-order="<?= $this->e($row['headline']); ?>" style="border-left: 3px solid <?php echo $border_color;?>!important"><a href="<?= BASE_URL ?>/tickets/showTicket/<?= $this->e($row['id']); ?>"><?= $this->e($row['headline']); ?></a></td>
                        ...
                        <td data-order="<?= $row["editorFirstname"] != "" ?  $this->escape($row["editorFirstname"]) : $this->__("dropdown.not_assigned") ?>">
                            <div class="dropdown ticketDropdown userDropdown noBg show ">
                                <a class="dropdown-toggle f-left to-do-assign-to-selector" style="color:#000; " href="javascript:void(0);" role="button" id="userDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text">
                                    ...
                                    &nbsp;<i class="fa fa-caret-down" style="padding-top:5px; " aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-height-cs" style="position: absolute; left:-100px;" aria-labelledby="userDropdownMenuLink<?= $row['id'] ?>">
                                    <li class="nav-header border"><?= $this->__("dropdown.choose_user") ?></li>

                                    <?php foreach ($this->get('users') as $user) {
                                        echo "<li class='dropdown-item' style='text-align:left'>";
                        ...
                        <td data-order="<?= $statusLabels[$row['status']]["name"] ?>">
                            <div class="dropdown ticketDropdown statusDropdown colorized show">
                                <a class="dropdown-toggle to-do-s-selector f-left status <?= $statusLabels[$row['status']]["class"] ?>" href="javascript:void(0);" role="button" id="statusDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text">
                                        <?php echo $statusLabels[$row['status']]["name"]; ?>
                                    </span>
                                    &nbsp;<i class="fa fa-caret-down" style="padding-top:5px; " aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-height-css" style="left:-80px;" aria-labelledby="statusDropdownMenuLink<?= $row['id'] ?>">
                        ...
                        <td data-order="<?= $milestoneHeadline ?>">
                            <div class="dropdown ticketDropdown milestoneDropdown colorized show">
                                <a style="background-color:<?= $this->escape($row['milestoneColor']) ?>" class="dropdown-toggle f-left  label-default milestone to-do-m-selector" href="javascript:void(0);" role="button" id="milestoneDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text"><?= $milestoneHeadline ?></span>
                                    &nbsp;<i class="fa fa-caret-down" style="padding-top:5px; " aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-height-css" style="left:-80px;" aria-labelledby="milestoneDropdownMenuLink<?= $row['id'] ?>">
                        ...
                        <td data-order="<?= $row['storypoints'] ? $efforts[$row['storypoints']] : $this->__("label.story_points_unkown"); ?>">
                            <div class="dropdown ticketDropdown effortDropdown show">
                                <a class="dropdown-toggle f-left  label-default effort to-do-e-selector" href="javascript:void(0);" role="button" id="effortDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text"><?php
                                ...
                                <ul class="dropdown-menu dropdown-menu-height-css" style="left:-80px;" aria-labelledby="effortDropdownMenuLink<?= $row['id'] ?>">
                        ...
                        <td data-order="<?= $sprintHeadline ?>">
                            ...
                            <div class="dropdown ticketDropdown sprintDropdown show">
                                <a class="dropdown-toggle f-left  label-default sprint to-do-sprint-selector" href="javascript:void(0);" role="button" id="sprintDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text"><?= $sprintHeadline ?></span>
                                    <i class="fa fa-caret-down" style="padding-top:5px; " aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-height-css" style="left:-80px;" aria-labelledby="sprintDropdownMenuLink<?= $row['id'] ?>">
