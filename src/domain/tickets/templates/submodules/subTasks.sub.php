...
<p style="color: gray;" class="col-8"><i class="fas fa-info-circle"></i> <?=$this->__('text.what_are_subtasks') ?><br /><br /></p>
<h4 class="widgettitle title-light" style="padding-top: 0px;padding-bottom:0px; margin-bottom:0px;"><?php echo $this->__('subtitles.subtasks'); ?></h4>
...
<table cellpadding="0" cellspacing="0" border="0" class="allTickets table table-bordered"
    ...
    <thead>
        <tr>
            ...
            <th  width="40%"><?php echo $this->__('label.description'); ?></th>
    ...
    foreach($this->get('allSubTasks') as $subticket) {
        ...
        <tr>
            <form method="post" action="#subtasks">
                ...
                <td><textarea  name="description" style="width:100%; height:38px;margin-top:3px; margin-bottom:5px;"><?php $this->e($subticket['description']) ?></textarea></td>
                <td style="width:150px;" ><select class="span11 status-select" name="status" style="width:150px;margin-top:3px; margin-bottom:5px;"  data-placeholder="">
    ...
    <tr>
        <form method="post" action="#subtasks">
        <td><input type="text" placeholder="+ Create a new subtask:" value="" name="headline"/></td>
        <td><textarea  name="description" style="width:100%; height:38px;margin-top:3px; margin-bottom:5px;"></textarea></td>
        <td style="width:150px;">
            <select class="span11 status-select" name="status"  style="width:150px;margin-top:3px; margin-bottom:5px;" data-placeholder="">
                <?php foreach($statusLabels as $key=>$label){?>
                    <option value="<?php echo $key; ?>"
