    ...
    <div class="pagetitle">
        <div class="row">
            <div class="col-lg-8">
                ...
                <h1><?php //echo $this->__("headlines.project_with_name"); 
                    ?> <?php /*$this->e($this->get('currentProjectName'));*/ echo $this->__("headlines.dashboard"); ?></h1>
            </div>
        ...
        <div class="row">
            <div class="btn-group col-lg-4" role="group" style="margin-top:1rem;" aria-label="Basic example">
                <a href="javascript:void(0);" class="btn btn-primary btn-rounded btn-rounded" style="margin-right:1em;" id="ticket_new_link" onclick="jQuery('#ticket_new').toggle('fast'); jQuery(this).toggle('fast');"><i class="fas fa-plus-circle"></i> <?php echo $this->__("links.quick_add_todo"); ?></a>

                <?php echo $this->displayLink('users.newUser', "<i class='fa fa-user'></i> " . $this->__('buttons.add_user'), null, array('class' => 'btn btn-light btn-rounded')) ?>
            </div>
...
<div class="maincontent">
    <div class="maincontentinner">
        ...
        <div class="row">
            <div class="col-lg-9">
                <table class="table">
                    <thead class="thead-light">
                        <tr>
                            <th scope="col" width="20%"><?php echo $this->__("subtitles.todos_this_week"); ?>
                            </th>
                            <th scope="col" width="20%"> <?php echo $this->__("label.date"); ?></th>
                            <th scope="col"><?php echo $this->__("label.priority"); ?></th>
                            <th scope="col"><?php echo $this->__("lable.milestone"); ?></th>
                            <th scope="col"> <?php echo $this->__("label.status"); ?></th>
                            <th scope="col"><?php echo $this->__("label.action"); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        foreach ($this->get('tickets')["thisWeek"] as $row) {
                            $priority_element = '';
                            echo '<tr class="ticketBox fixed"">';
                            echo '<td><a href="' . BASE_URL . '/tickets/showTicket/' . $row['id'] . '" style="color:#000;">' . $row['headline'] . '</a></td>';
                            ...
                            echo '<td>' . '<input type="text" title=' . $this->__("label.date") . '" value="' . $date . '" class="duedates secretInput" style="border:0px solid!important;" data-id="' . $row['id'] . '" name="date" /></td>';
                        ?>

                            <td>
                                <div class="dropdown ticketDropdown effortDropdown show" style="display: inline;">
                                    <a class="dropdown-toggle f-left  label-default effort" style="width: 100%; height:40px; justify-content: space-between; display:flex; padding-top:10px;" href="javascript:void(0);" role="button" id="effortDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="text"><?php
                                        ...
                                        &nbsp;<i class="fa fa-caret-down" aria-hidden="true" style="padding-top: 4px;"></i>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-height-css" aria-labelledby="effortDropdownMenuLink<?= $row['id'] ?>" style="position:absolute; left:-70px;">
                            ...
                            <td style="padding: 0px;">
                                <div class="dropdown ticketDropdown milestoneDropdown colorized show" style="display: inline;">
                                    <a style="background-color:<?= $this->escape($row['milestoneColor']) ?>; height:40px; width:100%; display:flex; justify-content:space-between; padding-top:10px;" class="dropdown-toggle f-left  label-default milestone" href="javascript:void(0);" role="button" id="milestoneDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="text"><?php
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-height-css" style="position:absolute; left:-70px;" aria-labelledby="milestoneDropdownMenuLink<?= $row['id'] ?>">
                            ...
                            <td style="padding:0px;">
                                <div class="dropdown ticketDropdown statusDropdown colorized show" style="display: inline;">
                                    <a class="dropdown-toggle f-left status <?= $statusLabels[$row['status']]["class"] ?>" href="javascript:void(0);" style="width:100%; height:40px; display:flex; justify-content:space-between; padding-top:10px;" role="button" id="statusDropdownMenuLink<?= $row['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="text"><?php
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-height-css" style="position:absolute; left:-70px;" aria-labelledby="statusDropdownMenuLink<?= $row['id'] ?>">
                            ...
                            ?>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a class="btn btn-light" style="background: transparent; border: 0px;">
                                            <?php if (is_array($clockedIn) == true) {
                                                echo sprintf(date($this->__("language.timeformat"), $clockedIn["since"]));
                                            } else {
                                                echo sprintf(date($this->__("language.timeformat"), time()));
                                            } ?>
                                        </a>
                                        <span id="timerContainer-<?php echo $row['id']; ?>" class="timerContainer">
                                            <a class="punchIn btn btn-light" style="background: #ffffff; border:0px solid; border-radius:8px;" href="javascript:void(0);" data-value="<?php echo $row["id"]; ?>" <?php if ($clockedIn !== false) {
                                                                                                                                                    echo "style='display:none;'";
                                                                                                                                                } ?>><span class="iconfa-time"> Start</span></a>
                                            <a class="punchOut stop-timer-dashboard btn btn-light" href="javascript:void(0);" data-value="<?php echo $row["id"]; ?>" <?php if ($clockedIn === false || $clockedIn["id"] != $row["id"]) {
                                                                                                                                                    echo "style='display:none;'";
                                                                                                                                                } ?>><span class="iconfa-time"> Stop</span></a>
                                            <span class='working' <?php if ($clockedIn === false || $clockedIn["id"] === $row["id"]) {
                                                                        echo "style='display:none;'";
                                                                    } ?>></span>
                                        </span>
                                        <a href="<?= BASE_URL ?>/tickets/showTicket/<?php echo $row["id"]; ?>" class="btn btn-light" style="background: transparent; border: 0px;"><i class="fas fa-pencil-alt"></i> </a>
                                        <a href="<?= BASE_URL ?>/tickets/delTicket/<?php echo $row["id"]; ?>" class="delete btn btn-light"  style="background: transparent; border: 0px;"><i class="fas fa-times"></i></a>
                                    </div>
                                    <!-- <div class="row">
                                        <div class="col-5">
                                            <span>
                                        ...
                                        <div class="col-2">
                                            <a href="<?= BASE_URL ?>/tickets/showTicket/<?php echo $row["id"]; ?>"><i class="fa fa-edit"></i> </a>
                                        </div>
                                        <div class="col-2">
                                            <a href="<?= BASE_URL ?>/tickets/delTicket/<?php echo $row["id"]; ?>" class="delete"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </div> -->
                                </td>
            ...
            <div class="col-lg-3">
                <div class="row" id="projectProgressContainer" style="border: 1px solid #e6e9f0; border-radius:10px; padding-top:20px">
                    <div class="col-md-12">
                                                        ...
                                                        <div class="inlineDropDownContainer">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li id="timerContainer-<?php echo $row['id']; ?>" class="timerContainer">
                                                                    ...
                                                                    <a class="punchOut" href="javascript:void(0);" data-value="<?php echo $row["id"]; ?>" <?php if ($clockedIn === false || $clockedIn["id"] != $row["id"]) {
                                                                                                                                                                echo "style='display:none;'";
                                                                                                                                                            } ?>><span class="iconfa-stop"></span> <?php echo sprintf($this->__("links.stop_work_started_at"), date($this->__("language.timeformat"), $clockedIn["since"] ?? time())); ?></a>
                                                                    <span class='working' <?php if ($clockedIn === false || $clockedIn["id"] === $row["id"]) {
                                                                                                echo "style='display:none;'";
                                                                                            } ?>><?php echo $this->__("text.timer_set_other_todo"); ?></span>
                                                                </li>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        <?php if ($sprintBurndown != []) { ?>
            ...
            //leantime.dashboardController.initBurndown([<?php foreach ($sprintBurndown as $value) echo "'" . $value['date'] . "',"; ?>], [<?php foreach ($sprintBurndown as $value) echo "'" . round($value['plannedNum'], 2) . "',"; ?>], [ <?php foreach ($sprintBurndown as $value) {
                                                                                                                                                                                                                                                    if ($value['actualNum'] !== '') echo "'" . $value['actualNum'] . "',";
                                                                                                                                                                                                                                                };  ?> ]);
            leantime.dashboardController.initChartButtonClick('HourlyChartButton', [<?php foreach ($sprintBurndown as $value) echo "'" . $value['plannedHours'] . "',"; ?>], [<?php foreach ($sprintBurndown as $value) {
                                                                                                                                                                                    if ($value['actualHours'] !== '') echo "'" . round($value['actualHours']) . "',";
                                                                                                                                                                                };  ?>]);
            leantime.dashboardController.initChartButtonClick('EffortChartButton', [<?php foreach ($sprintBurndown as $value) echo "'" . $value['plannedEffort'] . "',"; ?>], [<?php foreach ($sprintBurndown as $value) {
                                                                                                                                                                                    if ($value['actualEffort'] !== '') echo "'" . $value['actualEffort'] . "',";
                                                                                                                                                                                };  ?>]);
            leantime.dashboardController.initChartButtonClick('NumChartButton', [<?php foreach ($sprintBurndown as $value) echo "'" . $value['plannedNum'] . "',"; ?>], [<?php foreach ($sprintBurndown as $value) {
                                                                                                                                                                                if ($value['actualNum'] !== '') echo "'" . $value['actualNum'] . "',";
                                                                                                                                                                            };  ?>]);
        ...
        <?php if ($backlogBurndown != []) { ?>
            ...
            //leantime.dashboardController.initBacklogBurndown([<?php foreach ($backlogBurndown as $value) echo "'" . $value['date'] . "',"; ?>], [ <?php foreach ($backlogBurndown as $value) {
                                                                                                                                                        if ($value['actualNum'] !== '') echo "'" . $value['actualNum'] . "',";
                                                                                                                                                    };  ?> ]);
